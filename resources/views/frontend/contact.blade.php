...
@section('content')
    <main>
        <section class="relative overflow-hidden bg-[radial-gradient(circle_at_69%_43%,#ffd516_0,transparent_20%),linear-gradient(110deg,#fffdf8,#f5eee5)]">
            <div class="mx-auto grid max-w-7xl items-center gap-8 px-6 py-14 lg:grid-cols-2 lg:px-8">
                ...
                <div class="relative mx-auto h-96 w-full max-w-lg"><p class="absolute left-4 top-3 z-10 font-serif text-3xl italic -rotate-12">Same chai,<br>just healthier ♡</p><div class="absolute bottom-2 left-8 h-35 w-28 rounded-b-full border-4 border-white/60 bg-[#c77a3e] shadow-xl"><div class="mt-4 h-4 bg-[#f5d5ba]"></div></div><div class="absolute bottom-0 right-4 w-56 rounded-t-xl bg-gradient-to-b from-zinc-700 via-[#111] to-black px-5 pb-5 pt-8 shadow-2xl sm:w-64"><div class="text-center text-3xl font-black tracking-tighter text-white">SWEAT</div><div class="text-center font-serif text-3xl font-bold italic text-[#ffd100]">nothing.</div><div class="mt-5 border-y border-white/20 py-4 text-sm font-bold text-white">SWEETNESS<br>WITHOUT<br><span class="text-[#ffd100]">THE SUGAR</span></div><div class="mt-5 bg-[#ffd100] px-3 py-4 text-[8px] font-black">FOR A HEALTHIER YOU</div></div></div>
            </div>
        </section>

        <section class="contact-form-layout mx-auto grid max-w-7xl gap-6 px-6 py-10 lg:grid-cols-[1.25fr_.95fr] lg:px-8">
            <form class="rounded-3xl border border-black/5 bg-white p-7 shadow-sm"><p class="text-xs font-bold tracking-[.3em]">SEND US A MESSAGE</p><h2 class="mt-2 text-4xl font-black tracking-[-.05em]">Let's <span class="text-[#ffca00]">Connect</span></h2><p class="mt-2">Fill out the form and our team will get back to you soon.</p><div class="mt-6 grid gap-4 sm:grid-cols-2"><input class="rounded-xl border border-black/15 p-4" placeholder="Your Name *"><input class="rounded-xl border border-black/15 p-4" placeholder="Your Email *"><input class="rounded-xl border border-black/15 p-4" placeholder="Phone Number"><select class="rounded-xl border border-black/15 p-4"><option>Subject *</option></select></div><textarea class="mt-4 h-32 w-full rounded-xl border border-black/15 p-4" placeholder="Your Message *"></textarea><label class="mt-4 block text-sm"><input type="checkbox"> I agree to the privacy policy.</label><button type="button" class="mt-5 w-full rounded-full bg-[#ffd100] py-4 font-bold">Send Message →</button></form>
            <div class="rounded-3xl bg-[#fff1c5] p-7"><h2 class="text-2xl font-black">Our Contact Details</h2><p class="mt-1 text-sm">Reach us through any of the following channels.</p><div class="mt-7 space-y-5"><p><b>📍 Our Address</b><br>Tower-C, Cyber Park, 712 A,<br>Noida – 62, India</p><p><b>☎ Call Us</b><br>+91 20 456 7890<br><span class="text-sm text-black/60">Mon – Fri, 10:00 AM – 6:00 PM</span></p><p><b>✉ Email Us</b><br>hello@sweatnothing.in<br><span class="text-sm text-black/60">We'll get back to you within 24 hours.</span></p><p><b>◷ Business Hours</b><br>Monday – Friday: 10:00 AM – 6:00 PM<br>Saturday: 10:00 AM – 2:00 PM</p></div></div>
        </section>
