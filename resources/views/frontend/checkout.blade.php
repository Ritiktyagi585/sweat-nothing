        ...
        <section class="mt-6 grid gap-6 lg:grid-cols-[1fr_340px]">
            <form action="{{ route('checkout.address.store') }}" method="POST" class="rounded-2xl bg-white p-5 shadow-sm sm:p-7">
                ...
                <div class="mt-5 grid gap-4 sm:grid-cols-2">
                    ...
                    <div><label for="phone" class="text-sm font-semibold">Mobile Number *</label><input id="phone" name="phone" value="{{ old('phone', $address['phone'] ?? '') }}" class="mt-2 w-full rounded-lg border border-black/15 px-3 py-3 text-sm outline-none focus:border-[#ffd100]" type="tel" required></div>
                </div>
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-3">
                    ...
                    <div><label for="pincode" class="text-sm font-semibold">Pincode *</label><input id="pincode" name="pincode" value="{{ old('pincode', $address['pincode'] ?? '') }}" class="mt-2 w-full rounded-lg border border-black/15 px-3 py-3 text-sm outline-none focus:border-[#ffd100]" inputmode="numeric" maxlength="6" required></div>
                </div>
